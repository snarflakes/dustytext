...
export class HelpCommand implements CommandHandler {
  async execute(): Promise<void> {
    const helpText = [
      ...
      '       [Craft] item: create new items from your inventory, workbench must be placed one block north when required for crafting items, type craft for even more info.',
      '       [Equip] use a tool from your inventory. Try using axe for wood, and a pick for seed harvesting, if you dont you will take damage!',
      ...
      '       [ProjectField] create a force field or program at your location, or at a specific coordinate, projectfield x y z,',
