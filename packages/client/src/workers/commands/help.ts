...
export class HelpCommand implements CommandHandler {
  async execute(): Promise<void> {
    const helpText = [
      ...
      '       Explore/exp <direction> (also sets above commands but examines a specific direction for 5 blocks, directions: north/n, east/e, south/s, west/w, northeast/ne, northwest/nw, southeast/se, southwest/sw),',
