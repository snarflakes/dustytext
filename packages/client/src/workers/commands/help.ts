...
export class HelpCommand implements CommandHandler {
  async execute(): Promise<void> {
    const helpText = [
      ...
      '       Health/hp,', 
      '       Explore/exp (examine your immediate environment, takes commands mine/water/build/till/fill to allow precise block selection),',
      '       Explore/exp <direction> (also accepts above commands but examines a specific direction for 5 blocks, directions: north/n, east/e, south/s, west/w, northeast/ne, northwest/nw, southeast/se, southwest/sw),',
